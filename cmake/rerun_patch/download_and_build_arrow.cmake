...
function(download_and_build_arrow)
    ...
    message(STATUS "DEBUG: CMAKE_POLICY_VERSION_MINIMUM is: ${CMAKE_POLICY_VERSION_MINIMUM}")
    ...
    ExternalProject_Add(
        ...
        # TODO(apache/arrow#45985): Arrow can't support CMake 4.0 yet
        PATCH_COMMAND python3 ${CMAKE_CURRENT_LIST_DIR}/patch_mimalloc.py ${ARROW_DOWNLOAD_PATH}/src/arrow_cpp/cpp/cmake_modules/ThirdpartyToolchain.cmake
